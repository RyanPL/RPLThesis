...
#ifdef ngraph_cxx
ngraph::ngraph(TTree *tree) : fChain(0) 
{
...
Int_t ngraph::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t ngraph::LoadTree(Long64_t entry)
{
...
void ngraph::Show(Long64_t entry)
{
...
Int_t ngraph::Cut(Long64_t entry)
{
