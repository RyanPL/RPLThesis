...
// Thu Oct  5 11:34:31 2017 by ROOT version 5.34/30
// from TTree h10/All_out
// found on file: /home/ryanpl/Capstone/root_51577_pass1.a16.root
//////////////////////////////////////////////////////////
...
public :
   ...
   virtual void zero2DArray(Double_t x[][300], Int_t d1, Int_t d2);
   virtual void zero1DArray(Double_t x[][300], Int_t d2);
   virtual void zero3DArray(Double_t x[][300], Int_t d1, Int_t d2, Int_t d3);
   virtual int getEnergy(Char_t e[3]);
   virtual void asymDS();
   virtual void combinedDS();
   
};

#endif

#ifdef makeGraphs_cxx
makeGraphs::makeGraphs(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/ryanpl/Capstone/root_51577_pass1.a16.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/ryanpl/Capstone/root_51577_pass1.a16.root");
      }
...
Int_t makeGraphs::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t makeGraphs::LoadTree(Long64_t entry)
{
...
void makeGraphs::Init(TTree *tree)
{
...
void makeGraphs::Show(Long64_t entry)
{
...
Int_t makeGraphs::Cut(Long64_t entry)
{
