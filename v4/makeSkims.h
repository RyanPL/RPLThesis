...
// Thu Oct  5 11:34:08 2017 by ROOT version 5.34/30
...
public :
   ...
   makeSkims(TTree *tree=0);
   virtual ~makeSkims();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     singleRunLoop(Char_t energylvl[10], Char_t runNum[10]);
...
#ifdef makeSkims_cxx
makeSkims::makeSkims(TTree *tree) : fChain(0) 
{
...
Int_t makeSkims::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t makeSkims::LoadTree(Long64_t entry)
{
...
void makeSkims::Init(TTree *tree)
{
...
void makeSkims::Show(Long64_t entry)
{
...
Int_t makeSkims::Cut(Long64_t entry)
{
