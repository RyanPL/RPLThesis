...
#ifdef dfapprox_cxx
dfapprox::dfapprox(TTree *tree) : fChain(0) 
{
...
Int_t dfapprox::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t dfapprox::LoadTree(Long64_t entry)
{
...
void dfapprox::Show(Long64_t entry)
{
...
Int_t dfapprox::Cut(Long64_t entry)
{
