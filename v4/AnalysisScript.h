...
// found on file: /home/ryanpl/Thesis/root_51577_pass1.a16.root
//////////////////////////////////////////////////////////

#ifndef AnalysisScript_h
#define AnalysisScript_h
...
public :
   ...
   AnalysisScript(TTree *tree=0);
   virtual ~AnalysisScript();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     n_spectra(Char_t runNum[10], Char_t target[5], Char_t energylvl[5]);
   virtual void     zero1DArray(Float_t a[], Int_t size);
   virtual void     zero2DArray(Float_t a[][75], Int_t s1, Int_t s2);
   virtual bool     checkForFile(const char *fname);
...
#ifdef AnalysisScript_cxx
AnalysisScript::AnalysisScript(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   //*                                               //ONLY comment out when testing makeHistos2
      if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/home/ryanpl/Thesis/root_51577_pass1.a16.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("/home/ryanpl/Thesis/root_51577_pass1.a16.root");
      }
...
Int_t AnalysisScript::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t AnalysisScript::LoadTree(Long64_t entry)
{
...
void AnalysisScript::Init(TTree *tree)
{
...
void AnalysisScript::Show(Long64_t entry)
{
...
Int_t AnalysisScript::Cut(Long64_t entry)
{
...
#endif // #ifdef AnalysisScript_cxx
